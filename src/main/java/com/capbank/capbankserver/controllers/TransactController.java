...
import com.capbank.capbankserver.repositories.PaymentRepository;
import com.capbank.capbankserver.repositories.TransactRepository;
...
public class TransactController {
    ...
    @PostMapping("/payment")
    public String payment(@RequestParam("holder")String holder,
        ...
        // TODO: CHECK FOR EMPTY VALUES:
        if(holder.isEmpty() || account_number.isEmpty() || account_id.isEmpty() || payment_amount.isEmpty()){
            errorMessage = "Holder, Account Number, Account Paying From and Payment Amount Cannot be Empty! ";
            redirectAttributes.addFlashAttribute("error", errorMessage);
            return "redirect:/app/dashboard";
        }
        ...
        if(currentBalance < paymentAmount){
            ...
            paymentRepository.makePayment(accountID, holder, account_number, paymentAmount, memo, "failed", reasonCode, currentDateTime);
        ...
        paymentRepository.makePayment(accountID, holder, account_number, paymentAmount, memo, "success", reasonCode, currentDateTime);
